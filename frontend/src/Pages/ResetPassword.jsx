...
import { Lock, Eye, EyeOff, CheckCircle, XCircle, Loader, Shield, KeyRound, ArrowRight } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute bottom-1/4 left-1/3 w-[400px] h-[400px] bg-indigo-600/6 rounded-full blur-[100px]" />
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border border-white/10 bg-white/[0.03] text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500/50 transition-all text-sm"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border border-white/10 bg-white/[0.03] text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500/50 transition-all text-sm font-mono tracking-wider"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-4 py-3 pr-11 rounded-xl border border-white/10 bg-white/[0.03] text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500/50 transition-all text-sm"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full px-4 py-3 pr-11 rounded-xl border bg-white/[0.03] text-white placeholder-gray-500 focus:outline-none focus:ring-2 transition-all text-sm ${confirmPassword
                                        ? passwordsMatch
                        ...
                        <div className="flex gap-3 pt-1">
                            <button
                                ...
                                className="flex-1 py-3 rounded-xl border border-white/10 bg-transparent text-gray-300 hover:bg-white/[0.03] hover:border-white/20 transition-all text-sm font-medium"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                className="flex-1 py-3 bg-white text-black font-semibold rounded-xl hover:bg-gray-100 transition-all disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center gap-2 group text-sm shadow-lg shadow-white/5"
                            >
                                {isLoading ? (
                                    <>
