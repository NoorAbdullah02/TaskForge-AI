            ...
            {is2FaRequired ? (
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-3 rounded-xl border border-white/10 bg-white/[0.02] text-white placeholder-gray-500 tracking-[0.5em] text-center font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500/50 transition-all text-lg"
                      placeholder="000000"
                    />
                  </div>
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  <Button variant="glass" onClick={handleGoogleSignIn} className="w-full" size="sm">
                  ...
                  <Button variant="glass" onClick={handleGithubSignIn} className="w-full" size="sm">
                ...
                <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center">
                    <span className="bg-transparent px-4 text-xs font-medium text-gray-500 uppercase tracking-wider">or continue with email</span>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  {/* Email */}
                  <div>
                    <label className="block text-xs font-semibold text-gray-400 tracking-wider uppercase mb-2">Email</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-11 pr-11 py-3 rounded-xl border bg-white/[0.02] text-white placeholder-gray-500 focus:outline-none focus:ring-2 transition-all text-sm ${email && !isEmailValid
                  ...
                  {/* Password */}
                  <div>
                    <label className="block text-xs font-semibold text-gray-400 tracking-wider uppercase mb-2">Password</label>
                    <div className="relative">
                      <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 pointer-events-none" />
                      <input
                        ...
                        className="w-full pl-11 pr-11 py-3 rounded-xl border border-white/10 bg-white/[0.02] text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500/50 transition-all text-sm"
