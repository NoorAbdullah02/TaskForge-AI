...
import { 
    ...
    ArrowRight, Building, Key, Sparkles, Loader 
} from 'lucide-react';
...
const RegisterPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#07070d] flex items-center justify-center p-4 relative overflow-hidden text-slate-100">
            {/* Background effects */}
            ...
            <div className="w-full max-w-lg relative z-10 my-10">
                ...
                {!firstTimeSetup && (
                    <div className="flex bg-white/[0.02] border border-white/5 p-1 rounded-2xl mb-6">
                        <button
                            ...
                            className={`flex-1 py-3 text-xs font-bold rounded-xl transition cursor-pointer ${
                                activeTab === 'create'
                ...
                {/* Registration Card */}
                <motion.div
                    className="rounded-3xl border border-white/10 bg-white/[0.02] backdrop-blur-xl p-8 shadow-2xl"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                >
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-11 pr-11 py-3 bg-white/[0.03] border rounded-2xl focus:outline-none focus:ring-1 focus:ring-blue-500/20 text-xs font-semibold text-slate-200 placeholder-slate-500 ${
                                        emailError ? 'border-red-500/50' : isEmailValid ? 'border-emerald-500/50' : 'border-white/10'
                                    }`}
                                    required
                                />
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="••••••••"
                                        className={`w-full pl-11 pr-10 py-3 bg-white/[0.03] border rounded-2xl text-xs font-semibold focus:outline-none focus:border-blue-500 text-slate-200 ${
                                            confirmPassword ? (passwordsMatch ? 'border-emerald-500/50' : 'border-red-500/50') : 'border-white/10'
                                        }`}
                                        required
                                    />
                                    <button
                        ...
                        {password && (
                            <div className="bg-white/[0.01] border border-white/5 p-3 rounded-2xl space-y-2 mt-1">
                                ...
                                <div className="flex gap-1">
                                    {[1, 2, 3, 4].map(idx => (
                                        <div key={idx} className={`h-1 flex-1 rounded-full transition ${
                                            idx <= passwordStrength.level ? passwordStrength.color : 'bg-white/5'
                                        }`} />
                                    ))}
                                </div>
                            </div>
                        ...
                        <button
                            ...
                            className="w-full py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-2xl hover:shadow-lg hover:shadow-blue-500/10 active:scale-[0.98] transition disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center gap-2 group text-xs mt-4 cursor-pointer"
                        >
                            {isLoading ? (
                                <>
